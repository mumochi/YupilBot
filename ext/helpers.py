...
class Helpers:
    ...
    async def valid_message(self, channel: discord.TextChannel, message_id: str):
    ...
    async def valid_url(self, url: typing.Union[str, None]):
    ...
    async def valid_avatar(self, member: discord.Member):
